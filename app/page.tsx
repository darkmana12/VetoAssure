...
const LIST_ITEMS = [
  ...
  },
  {
    ...
    score: 8.1,
    stars: '★★★★☆',
    points: ['Maladies chroniques', 'Téléconsult', 'Devis immédiat'],
  ...
  },
  {
    ...
    score: 7.9,
    stars: '★★★★☆',
    points: ['100% en ligne', 'Accidents+maladies', 'Appli mobile'],
  ...
  },
  {
    ...
    score: 7.6,
    stars: '★★★½☆',
    points: ['Dès 7€/mois', 'Spécialiste', 'Formules modulables'],
  ...
  },
  {
    ...
    score: 7.2,
    stars: '★★★½☆',
    points: ['Souscription 3min', 'Accidents complet', 'Résiliation facile'],
