...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/a-propos`,         lastModified: new Date('2026-05-04'), changeFrequency: 'yearly',  priority: 0.5 },
    { url: `${BASE}/methodologie`,     lastModified: new Date('2026-05-04'), changeFrequency: 'monthly', priority: 0.6 },
